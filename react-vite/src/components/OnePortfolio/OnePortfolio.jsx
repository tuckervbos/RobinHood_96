						...
						{portfolio[0].stocks.map((stock) => (
							<Link key={stock.id} to={`/stocks/${stock.id}`}>
								<li className="StockLi">
									...
									<button type="button" onClick={(e) => sellEvent(e, stock)}>
										Sell
									</button>
									<button type="button" onClick={(e) => buyEvent(e, stock)}>
										Buy
									</button>
									<button type="button" onClick={(e) => deleteEvent(e, stock)}>
										Delete Stock
									</button>
								</li>
							</Link>
						...
						{showsell && (
							<CustomModal onClose={sellEvent}>
								...
								<div className="SellButtons">
									{sellErrors.error && (
										<p className="SellError">{sellErrors.error}</p>
									)}
									<button
										type="button"
										onClick={(e) =>
									...
									<button type="button" onClick={(e) => sellEvent(e)}>
										No
									</button>
								</div>
							</CustomModal>
						...
						{showBuy && (
							<CustomModal onClose={buyEvent}>
								...
								<div className="buyButtons">
									{buyErrors.error && (
										<p className="buyError">{buyErrors.error}</p>
									)}
									<button
										type="button"
										onClick={(e) =>
									...
									<button type="button" onClick={(e) => buyEvent(e)}>
										No
									</button>
								</div>
							</CustomModal>
						...
						{showDelete && (
							<CustomModal onClose={deleteEvent}>
								<div className="deleteMessage">
									This will sell all shares of the stock and remove it from the
