				...
				{showConfirmDelete && (
					<CustomModal onClose={deleteEvent}>
						<div className="deleteMessage">
							This will sell all stocks in the portfolio and delete the
							portfolio, confirm delete?
						</div>
						<div className="deleteButtons">
							<button
								type="button"
								onClick={(e) => handleDelete(e, portfolioToDelete.portfolio_id)}
							>
								Confirm
							</button>
					...
					<CustomModal onClose={createEvent}>
						...
						<div className="createButtons">
							<label className="creatSpotLabel">
								...
								/>
								{errors.name && (
									<span className="PortfolioError">{errors.name}</span>
								)}
							</label>
					...
					<CustomModal onClose={(e) => editEvent(e)}>
						...
						<div className="editButtons">
							<label className="editSpotLabel">
								...
								/>
								{editErrors.name && (
									<span className="PortfolioError">{editErrors.name}</span>
								)}
							</label>
							<button
								type="button"
